      ...
      <aside className="admin-sidebar">
          ...
          {adminNavItems.map((item) => (
            ...
            >
              <div className="relative">
                ...
                {['All Complaints', 'Pending', 'In Progress', 'Resolved'].includes(item.label) && unreadComplaintsCount > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-3 w-3 bg-red-500 border border-white shadow-sm"></span>
                  </span>
        ...
        <div className="sidebar-footer">
          <button 
            ...
            className="sidebar-ai-card group hover:bg-indigo-600 hover:text-white transition-all cursor-pointer w-full text-left"
          >
